# -*- coding: utf-8 -*-
"""
Created on Sat Feb 17 10:36:59 2018
...
body = solid_object(100, P/4, 9.8, 1.0, Plotter())
...
class dumbbell(solid_object):
    ...
    def position(self, time, interval):
         ...
         for i in range(0,interval):
           l=line.Line2D([x1[i],x2[i]], [y1[i],y2[i]], lw=2, color='black')
